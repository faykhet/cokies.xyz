...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTintColor(eventsFunctionContext.getArgument("ColorTint"));
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFlashDuration(eventsFunctionContext.getArgument("FlashDuration"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.SetHalfPeriodTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashColor.FlashColor.prototype.SetHalfPeriodTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setHalfPeriodTime(eventsFunctionContext.getArgument("Value"));
}
}}
